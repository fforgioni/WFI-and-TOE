# -*- coding: utf-8 -*-
"""
Created on Sat Jun 14 19:16:30 2025
...
# === Colormap ===
colors_toe = ["#fde0dd", "#fa9fb5", "#c51b8a", "#7a0177", "#49006a"]
...
def panel_mapa(ax, data, title, cmap, norm, hatch_mask=None):
    ...
    if "(a)" in title:
        ax.text(0.98, 0.98, "(a)", transform=ax.transAxes,
                fontsize=30, fontweight='bold', va='top', ha='right', zorder=30)
        ax.set_title("FWI95d-RCP4.5", fontsize=18, pad=12)
    elif "(b)" in title:
        ax.text(0.98, 0.98, "(b)", transform=ax.transAxes,
                fontsize=30, fontweight='bold', va='top', ha='right', zorder=30)
        ax.set_title("FWI95d-RCP8.5", fontsize=18, pad=12)
...
def panel_inferior(ax, df, hist, years, year_50, titulo):
    ...
    if "(c)" in titulo:
        ...
        ax.set_title("FWI95d–RCP4.5", fontsize=18, pad=10)
    elif "(d)" in titulo:
        ax.text(0.01, 0.98, "(b)", transform=ax.transAxes,
                fontsize=30, fontweight='bold', va='top', ha='left', zorder=20)
        ax.set_title("FWI95d–RCP8.5", fontsize=18, pad=10)
...
# === Cargar datos ===
toe_45 = xr.open_dataarray("C:/Users/ferfo/OneDrive/Escritorio/ToE_FWI95d_rcp45.nc")
toe_85 = xr.open_dataarray("C:/Users/ferfo/OneDrive/Escritorio/ToE_FWI95d_rcp85.nc")
...
plot_doble_mapa(
    ...
    "C:/Users/ferfo/OneDrive/Escritorio/figura_doble_mapa_FWI95d.png"
)
...
plot_doble_histograma(
    ...
    "C:/Users/ferfo/OneDrive/Escritorio/figura_doble_histograma_FWI95d.png"
)
