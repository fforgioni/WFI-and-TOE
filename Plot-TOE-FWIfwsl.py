# -*- coding: utf-8 -*-
"""
Created on Sun Jun  1 02:24:54 2025
...
colors_toe = ["#ffe5b4", "#ffc685", "#ff944d", "#e65c00", "#993d00", "#4d1f00"]
...
def panel_mapa(ax, data, title, cmap, norm, hatch_mask=None):
    ...
    if "(c)" in title:
        ax.text(0.98, 0.98, "(c)", transform=ax.transAxes,
                fontsize=30, fontweight='bold', va='top', ha='right', zorder =30)
        ax.set_title("FWIfwsl–RCP4.5", fontsize=18, pad=12)
    elif "(d)" in title:
        ax.text(0.98, 0.98, "(d)", transform=ax.transAxes,
                fontsize=30, fontweight='bold', va='top', ha='right', zorder =30)
        ax.set_title("FWIfwsl–RCP8.5", fontsize=18, pad=12)
...
def panel_inferior(ax, df, hist, years, year_50, titulo):
    ...
    if "(c)" in titulo:
        ax.text(0.01, 0.98, "(c)", transform=ax.transAxes,
                fontsize=30, fontweight='bold', va='top', ha='left', zorder=20)
        ax.set_title("FWIfwsl–RCP4.5", fontsize=18, pad=10)
    elif "(d)" in titulo:
        ax.text(0.01, 0.98, "(d)", transform=ax.transAxes,
                fontsize=30, fontweight='bold', va='top', ha='left', zorder=20)
        ax.set_title("FWIfwsl–RCP8.5", fontsize=18, pad=10)
...
# === Cargar datos ===
toe_45 = xr.open_dataarray("C:/Users/ferfo/OneDrive/Escritorio/ToE_FWIfwsl_rcp45.nc")
toe_85 = xr.open_dataarray("C:/Users/ferfo/OneDrive/Escritorio/ToE_FWIfwsl_rcp85.nc")
...
plot_doble_mapa(
    ...
    "C:/Users/ferfo/OneDrive/Escritorio/figura_doble_mapa_FWIfwsl.png"
)

plot_doble_histograma(
    df_45, hist_45, years_45, y50_45, "(c) Temp anomaly + Emergence FWI95d - RCP4.5",
    df_85, hist_85, years_85, y50_85, "(d) Temp anomaly + Emergence FWI95d - RCP8.5",
    "C:/Users/ferfo/OneDrive/Escritorio/figura_doble_histograma_FWIfwsl.png"
)
